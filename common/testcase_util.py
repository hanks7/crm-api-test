...
from common.util_func import cur_timestamp
...
def regx_sub(string, vars_dict):
    ...
    '${host}/login'
    vars_dict = {'host': 'http://82.156.74.26:9099', 'username': 18866668888, 'password': 123456,
                 'token': '2fde6f8d8fcc4e949470fd72a8a6a25a', 'timestamp': 1655920880380}
